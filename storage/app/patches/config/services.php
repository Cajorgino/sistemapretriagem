...
return [
    ...
    */
    ...
    /*
    | GestRisk / CCF — API FastAPI (predição, SHAP, priorização)
    | POST {url}/analisar/completo — JSON PredictionInput
    */
    'ccf_api' => [
        'url' => rtrim(env('CCF_API_URL', env('PYTHON_API_URL', 'http://127.0.0.1:8010')), '/'),
